...
void GameListModelUT::data()
{
    GameListModel* listModel = new GameListModel();
    QAbstractItemModel* itemModel = qobject_cast<QAbstractItemModel*>(listModel);
    QCOMPARE(itemModel->data(itemModel->index(0,0), Qt::DisplayRole), QVariant());
    ...
    QCOMPARE(itemModel->data(itemModel->index(1,0), GameListModel::SolitareIdRole).toString(), QString("pyramid"));
    QCOMPARE(itemModel->data(itemModel->index(1,0), GameListModel::SolitaireNameRole).toString(), QString("TR_Pyramid"));
    QCOMPARE(itemModel->data(itemModel->index(1,0), GameListModel::SolitaireImageUriRole).toString(), QString("images/pyramid_solitaire.png"));
    ...
    QCOMPARE(itemModel->data(itemModel->index(4,0), GameListModel::SolitareIdRole).toString(), QString("blackred"));
    QCOMPARE(itemModel->data(itemModel->index(4,0), GameListModel::SolitaireNameRole).toString(), QString("TR_Classic Black And Red"));
    QCOMPARE(itemModel->data(itemModel->index(4,0), GameListModel::SolitaireImageUriRole).toString(), QString("images/black_red.png"));
    QCOMPARE(itemModel->data(itemModel->index(numOfGames,0), Qt::DisplayRole), QVariant());
    ...
    QCOMPARE(itemModel->data(itemModel->index(0,numberOfColumnsInOneColumnList), Qt::DisplayRole), QVariant());
